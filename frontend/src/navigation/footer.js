...
const Footer = (props) => {
    ...
    <>
      ...
      <footer className="text-center text-white bg-[#caced1]" >
        <div className="container p-6 m-auto">
          <div className="grid xs:grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        ...
        <div
          className="text-center w-full  p-4 bg-[rgba(0, 0, 0, 0.2)]"
        >
          © 2022 Copyright:
  ...
  <div className=" w-full m-auto p-9 text-center text-white bg-[#f1f1f1]">
    <div className="flex justify-center">
      ...
      <a href="https://www.linkedin.com/in/vishal-here-/" className="mr-9 text-gray-800">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
      ...
      <a href="https://github.com/vishal-here" className="text-gray-800">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
